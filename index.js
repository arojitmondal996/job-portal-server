...
async function run() {
  try {
    ...
    // mongodb theke data ta niye asar jonno prothom ea ekta collection create korte hobe
    ...
    // 22222222 details page ea dekhanor jonno id dhore dekhabo
    ...
    // 555555555 create kora kajta korte hobe post er madhome
    ...
    //333333333 job application api
    app.post('/job-application', async (req, res) => {
      const application = req.body;
      const result = await jobApplication.insertOne(application);
      
      // 777777777 not the best way (use aggregate)
      // skip --> it
    ...
    // 888888888 get a specific job application by id
    ...
    // 999999999 update korar jonno patch marte hobe
